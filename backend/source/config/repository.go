...
func (r Repository) AuthBasicBoxUser() string {
	return r.s.Auth.Basic.Box.User
}

func (r Repository) AuthBasicBoxPassword() string {
	return r.s.Auth.Basic.Box.Password
}
